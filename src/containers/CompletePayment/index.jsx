...
const STATUS_CONTENT_MAP = {
  ...
  processing: {
    text: 'Seu pagamento está em processo.',
    iconColor: '#6D6E78',
    icon: InfoIcon,
  },
  requires_payment_method: {
    text: 'Seu pagamento não foi aceito, por favor tente novamente.',
    iconColor: '#DF1B41',
    icon: ErrorIcon,
  },
  default: {
...
export function CompletePage() {
  ...
  if (isLoading) {
    return <h2 id="loading-message">Carregando...</h2>;
  }
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td id="intent-status" className="TableContent">
                    {status === 'succeeded' ? 'Sucesso' : status}
                  </td>
                </tr>
              </tbody>
            </table>
